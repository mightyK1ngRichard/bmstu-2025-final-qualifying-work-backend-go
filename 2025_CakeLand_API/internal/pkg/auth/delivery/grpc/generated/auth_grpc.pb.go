...
const (
	...
	Auth_UpdateAccessToken_FullMethodName = "/Auth/UpdateAccessToken"
...
type AuthClient interface {
	...
	UpdateAccessToken(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*UpdateAccessTokenResponse, error)
...
func (c *authClient) UpdateAccessToken(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*UpdateAccessTokenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AuthServer interface {
	...
	UpdateAccessToken(context.Context, *emptypb.Empty) (*UpdateAccessTokenResponse, error)
...
func (UnimplementedAuthServer) UpdateAccessToken(context.Context, *emptypb.Empty) (*UpdateAccessTokenResponse, error) {
...
func _Auth_UpdateAccessToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).UpdateAccessToken(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
